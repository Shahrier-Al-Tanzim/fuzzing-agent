...
30217 bytes → 27272 bytes (10% smaller) via `delta-debugging` in 8 steps.
...
harness/build/toml_harness triage/reports/run_24/nested_arrays-939402a0547c/minimized.toml
