...
**Type:** `stack-overflow`
**Occurrences:** 92 input(s) mapped to this signature
...
29967 bytes → 27046 bytes (10% smaller) via `delta-debugging` in 8 steps.
...
harness/build/toml_harness triage/reports/run_21/nested_arrays-939402a0547c/minimized.toml
