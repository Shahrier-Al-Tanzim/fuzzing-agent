...
**Type:** `stack-overflow`
**Occurrences:** 198 input(s) mapped to this signature
...
120006 bytes → 17969 bytes (85% smaller) via `delta-debugging` in 19 steps.
...
harness/build/toml_harness triage/reports/run_36/nested_arrays-939402a0547c/minimized.toml
