...
**Type:** `stack-overflow`
**Occurrences:** 52 input(s) mapped to this signature
...
360005 bytes → 342005 bytes (5% smaller) via `delta-debugging` in 4 steps.
...
harness/build/toml_harness triage/reports/run_27/alternating_array_inline_table_nesting-3db1e06f41e9/minimized.toml
