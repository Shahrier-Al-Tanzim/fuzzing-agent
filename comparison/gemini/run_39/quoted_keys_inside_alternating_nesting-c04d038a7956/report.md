...
**Type:** `stack-overflow`
**Occurrences:** 135 input(s) mapped to this signature
...
160013 bytes → 144413 bytes (10% smaller) via `delta-debugging` in 5 steps.
...
harness/build/toml_harness triage/reports/run_39/quoted_keys_inside_alternating_nesting-c04d038a7956/minimized.toml
