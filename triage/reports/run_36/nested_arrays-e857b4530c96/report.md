...
**Type:** `stack-overflow`
**Occurrences:** 265 input(s) mapped to this signature
...
120008 bytes → 120008 bytes (0% smaller) via `delta-debugging` in 7 steps.
...
harness/build/toml_harness triage/reports/run_36/nested_arrays-e857b4530c96/minimized.toml
