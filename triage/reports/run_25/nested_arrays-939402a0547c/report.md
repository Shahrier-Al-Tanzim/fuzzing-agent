...
**Type:** `stack-overflow`
**Occurrences:** 240 input(s) mapped to this signature
...
29809 bytes → 29809 bytes (0% smaller) via `delta-debugging` in 6 steps.
...
harness/build/toml_harness triage/reports/run_25/nested_arrays-939402a0547c/minimized.toml
