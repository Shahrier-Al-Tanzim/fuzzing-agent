...
**Type:** `stack-overflow`
**Occurrences:** 208 input(s) mapped to this signature
...
120005 bytes → 22058 bytes (82% smaller) via `delta-debugging` in 14 steps.
...
harness/build/toml_harness triage/reports/run_37/nested_arrays-939402a0547c/minimized.toml
