...
accepted: True
generated: 2026-09-02T23:12:10.016386+00:00
"""
...
def key(draw):
    return draw(
        st.one_of(
            ...
            st.text(alphabet=BASIC_KEY_SAFE, min_size=1, max_size=10).map(
                lambda text: '"' + text + '"'
            ),
...
def deep_dotted_key_document(draw):
    return "deep = " + draw(deep_dotted_key())
