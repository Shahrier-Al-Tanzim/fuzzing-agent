...
**Type:** `stack-overflow`
**Occurrences:** 236 input(s) mapped to this signature
...
31112 bytes → 31112 bytes (0% smaller) via `delta-debugging` in 6 steps.
...
harness/build/toml_harness triage/reports/run_25/nested_arrays-e857b4530c96/minimized.toml
