...
**Type:** `stack-overflow`
**Occurrences:** 280 input(s) mapped to this signature
...
120005 bytes → 60005 bytes (50% smaller) via `delta-debugging` in 7 steps.
...
harness/build/toml_harness triage/reports/run_38/nested_arrays-e857b4530c96/minimized.toml
