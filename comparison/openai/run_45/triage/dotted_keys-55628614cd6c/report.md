...
**Type:** `stack-overflow`
**Occurrences:** 95 input(s) mapped to this signature
...
180005 bytes → 180005 bytes (0% smaller) via `delta-debugging` in 3 steps.
...
harness/build/toml_harness triage/reports/run_45/dotted_keys-55628614cd6c/minimized.toml
