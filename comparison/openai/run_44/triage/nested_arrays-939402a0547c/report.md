...
**Type:** `stack-overflow`
**Occurrences:** 44 input(s) mapped to this signature
...
120005 bytes → 28861 bytes (76% smaller) via `delta-debugging` in 15 steps.
...
harness/build/toml_harness triage/reports/run_44/nested_arrays-939402a0547c/minimized.toml
