...
**Type:** `stack-overflow`
**Occurrences:** 246 input(s) mapped to this signature
...
124233 bytes → 124233 bytes (0% smaller) via `delta-debugging` in 6 steps.
...
harness/build/toml_harness triage/reports/run_27/nested_arrays-e857b4530c96/minimized.toml
