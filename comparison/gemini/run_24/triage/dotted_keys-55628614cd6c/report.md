...
**Type:** `stack-overflow`
**Occurrences:** 3 input(s) mapped to this signature
...
181201 bytes → 181201 bytes (0% smaller) via `delta-debugging` in 3 steps.
...
harness/build/toml_harness triage/reports/run_24/dotted_keys-55628614cd6c/minimized.toml
