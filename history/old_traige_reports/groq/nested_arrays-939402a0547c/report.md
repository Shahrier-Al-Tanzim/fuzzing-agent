...
**Type:** `stack-overflow`
**Occurrences:** 153 input(s) mapped to this signature
...
33136 bytes → 20886 bytes (37% smaller) via `delta-debugging` in 15 steps.
...
harness/build/toml_harness triage/reports/nested_arrays-939402a0547c/minimized.toml
