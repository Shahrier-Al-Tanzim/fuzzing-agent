...
**Type:** `stack-overflow`
**Occurrences:** 182 input(s) mapped to this signature
...
120005 bytes → 24746 bytes (79% smaller) via `delta-debugging` in 18 steps.
...
harness/build/toml_harness triage/reports/run_38/nested_arrays-939402a0547c/minimized.toml
