...
**Type:** `stack-overflow`
**Occurrences:** 53 input(s) mapped to this signature
...
128020 bytes → 128020 bytes (0% smaller) via `delta-debugging` in 6 steps.
...
harness/build/toml_harness triage/reports/run_43/nested_arrays-e857b4530c96/minimized.toml
