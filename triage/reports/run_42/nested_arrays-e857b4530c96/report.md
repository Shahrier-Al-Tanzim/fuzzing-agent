...
**Type:** `stack-overflow`
**Occurrences:** 76 input(s) mapped to this signature
...
136906 bytes → 136906 bytes (0% smaller) via `delta-debugging` in 6 steps.
...
harness/build/toml_harness triage/reports/run_42/nested_arrays-e857b4530c96/minimized.toml
