...
**Type:** `stack-overflow`
**Occurrences:** 162 input(s) mapped to this signature
...
200005 bytes → 180505 bytes (10% smaller) via `delta-debugging` in 6 steps.
...
harness/build/toml_harness triage/reports/run_39/dotted_keys-55628614cd6c/minimized.toml
