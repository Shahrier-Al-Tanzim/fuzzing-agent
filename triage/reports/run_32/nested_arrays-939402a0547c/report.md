...
**Type:** `stack-overflow`
**Occurrences:** 194 input(s) mapped to this signature
...
120006 bytes → 17071 bytes (86% smaller) via `delta-debugging` in 20 steps.
...
harness/build/toml_harness triage/reports/run_32/nested_arrays-939402a0547c/minimized.toml
