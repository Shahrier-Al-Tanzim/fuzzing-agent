...
**Type:** `stack-overflow`
**Occurrences:** 220 input(s) mapped to this signature
...
96010 bytes → 32408 bytes (66% smaller) via `delta-debugging` in 12 steps.
...
harness/build/toml_harness triage/reports/run_50/nested_arrays-939402a0547c/minimized.toml
