...
**Type:** `stack-overflow`
**Occurrences:** 272 input(s) mapped to this signature
...
96008 bytes → 20429 bytes (79% smaller) via `delta-debugging` in 21 steps.
...
harness/build/toml_harness triage/reports/run_51/nested_arrays-939402a0547c/minimized.toml
