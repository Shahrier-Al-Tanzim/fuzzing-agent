...
**Type:** `stack-overflow`
**Occurrences:** 178 input(s) mapped to this signature
...
120006 bytes → 15408 bytes (87% smaller) via `delta-debugging` in 22 steps.
...
harness/build/toml_harness triage/reports/run_26/nested_arrays-939402a0547c/minimized.toml
