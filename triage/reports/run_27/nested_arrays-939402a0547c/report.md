...
**Type:** `stack-overflow`
**Occurrences:** 174 input(s) mapped to this signature
...
120005 bytes → 28505 bytes (76% smaller) via `delta-debugging` in 9 steps.
...
harness/build/toml_harness triage/reports/run_27/nested_arrays-939402a0547c/minimized.toml
