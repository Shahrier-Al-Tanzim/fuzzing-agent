...
**Type:** `stack-overflow`
**Occurrences:** 19 input(s) mapped to this signature
...
60540 bytes → 60540 bytes (0% smaller) via `delta-debugging` in 6 steps.
...
harness/build/toml_harness triage/reports/run_49/nested_arrays-e857b4530c96/minimized.toml
