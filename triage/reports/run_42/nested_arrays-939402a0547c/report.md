...
**Type:** `stack-overflow`
**Occurrences:** 51 input(s) mapped to this signature
...
120005 bytes → 15600 bytes (87% smaller) via `delta-debugging` in 27 steps.
...
harness/build/toml_harness triage/reports/run_42/nested_arrays-939402a0547c/minimized.toml
