...
**Type:** `stack-overflow`
**Occurrences:** 70 input(s) mapped to this signature
...
180001 bytes → 180001 bytes (0% smaller) via `delta-debugging` in 3 steps.
...
harness/build/toml_harness triage/reports/run_40/nested_arrays-e857b4530c96/minimized.toml
