...
**Type:** `stack-overflow`
**Occurrences:** 158 input(s) mapped to this signature
...
200005 bytes → 190005 bytes (5% smaller) via `delta-debugging` in 4 steps.
...
harness/build/toml_harness triage/reports/run_28/dotted_keys-55628614cd6c/minimized.toml
