...
**Type:** `stack-overflow`
**Occurrences:** 233 input(s) mapped to this signature
...
120005 bytes → 40505 bytes (66% smaller) via `delta-debugging` in 12 steps.
...
harness/build/toml_harness triage/reports/run_37/nested_arrays-e857b4530c96/minimized.toml
