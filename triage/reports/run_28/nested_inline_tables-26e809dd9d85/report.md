...
**Type:** `stack-overflow`
**Occurrences:** 160 input(s) mapped to this signature
...
340005 bytes → 306855 bytes (10% smaller) via `delta-debugging` in 5 steps.
...
harness/build/toml_harness triage/reports/run_28/nested_inline_tables-26e809dd9d85/minimized.toml
