...
**Type:** `stack-overflow`
**Occurrences:** 148 input(s) mapped to this signature
...
340005 bytes → 214292 bytes (37% smaller) via `delta-debugging` in 12 steps.
...
harness/build/toml_harness triage/reports/run_37/nested_inline_tables-26e809dd9d85/minimized.toml
