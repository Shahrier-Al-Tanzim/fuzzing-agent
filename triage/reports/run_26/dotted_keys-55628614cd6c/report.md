...
**Type:** `stack-overflow`
**Occurrences:** 170 input(s) mapped to this signature
...
200005 bytes → 200005 bytes (0% smaller) via `delta-debugging` in 3 steps.
...
harness/build/toml_harness triage/reports/run_26/dotted_keys-55628614cd6c/minimized.toml
