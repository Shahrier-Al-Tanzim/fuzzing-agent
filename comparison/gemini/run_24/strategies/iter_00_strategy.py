...
accepted: True
generated: 2026-08-19T20:04:15.503422+00:00
"""
...
def scalar_datetime(draw):
    ...
    kind = draw(st.sampled_from(["offset", "local_dt", "local_d", "local_t"]))
    if kind == "local_d":
        ...
        delim = draw(st.sampled_from(["T", "t", " "]))
        offset = draw(st.sampled_from(["Z", "+00:00", "-07:00", "+02:00", "+05:30"]))
