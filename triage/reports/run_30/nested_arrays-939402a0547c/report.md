...
**Type:** `stack-overflow`
**Occurrences:** 22 input(s) mapped to this signature
...
29764 bytes → 24244 bytes (18% smaller) via `delta-debugging` in 10 steps.
...
harness/build/toml_harness triage/reports/run_30/nested_arrays-939402a0547c/minimized.toml
