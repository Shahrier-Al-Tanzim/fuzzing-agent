# Crash 939402a0547c — stack-overflow@malloc

**Type:** `stack-overflow`
**Occurrences:** 226 input(s) mapped to this signature
...
Raw frames before normalization: 191
Consecutive identical frames collapsed: True

## Minimized reproducer

120006 bytes → 22058 bytes (82% smaller) via `delta-debugging` in 15 steps.
...
harness/build/toml_harness triage/reports/run_39/nested_arrays-939402a0547c/minimized.toml
