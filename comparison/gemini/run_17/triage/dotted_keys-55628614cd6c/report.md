...
**Type:** `stack-overflow`
**Occurrences:** 7 input(s) mapped to this signature
...
195265 bytes → 195265 bytes (0% smaller) via `delta-debugging` in 3 steps.
...
harness/build/toml_harness triage/reports/run_17/dotted_keys-55628614cd6c/minimized.toml
