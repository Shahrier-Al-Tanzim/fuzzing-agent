...
**Type:** `stack-overflow`
**Occurrences:** 242 input(s) mapped to this signature
...
121594 bytes → 121594 bytes (0% smaller) via `delta-debugging` in 6 steps.
...
harness/build/toml_harness triage/reports/run_32/nested_arrays-e857b4530c96/minimized.toml
