...
accepted: True
generated: 2026-08-19T10:30:58.166078+00:00
"""
...
# Non-ASCII UTF-8 string fragments (e.g. accented letters, CJK, emoji, Greek)
NON_ASCII_SAMPLES = [
    "café",
    "résumé",
    "日本語",
...
def key_value_line(draw):
    # Frequently reuse common key names to trigger duplicate key generation cleanly across sections or within lines
    k = draw(
        st.one_of(
            key_st,
...
@composite
def duplicate_key_block(draw):
    # Generates identical key assignments to exercise duplicate key logic explicitly
