...
**Type:** `stack-overflow`
**Occurrences:** 111 input(s) mapped to this signature
...
160005 bytes → 137185 bytes (14% smaller) via `delta-debugging` in 6 steps.
...
harness/build/toml_harness triage/reports/run_27/alternating_array_inline_table_nesting-80953bb88ca2/minimized.toml
