...
**Type:** `stack-overflow`
**Occurrences:** 252 input(s) mapped to this signature
...
120005 bytes → 120005 bytes (0% smaller) via `delta-debugging` in 6 steps.
...
harness/build/toml_harness triage/reports/run_28/nested_arrays-e857b4530c96/minimized.toml
