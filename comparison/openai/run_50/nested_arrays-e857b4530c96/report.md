...
**Type:** `stack-overflow`
**Occurrences:** 108 input(s) mapped to this signature
...
96010 bytes → 48008 bytes (50% smaller) via `delta-debugging` in 7 steps.
...
harness/build/toml_harness triage/reports/run_50/nested_arrays-e857b4530c96/minimized.toml
