...
**Type:** `stack-overflow`
**Occurrences:** 47 input(s) mapped to this signature
...
30782 bytes → 15016 bytes (51% smaller) via `delta-debugging` in 20 steps.
...
harness/build/toml_harness triage/reports/run_20/nested_arrays-939402a0547c/minimized.toml
