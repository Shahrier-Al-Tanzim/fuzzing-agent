...
**Type:** `stack-overflow`
**Occurrences:** 110 input(s) mapped to this signature
...
120005 bytes → 30005 bytes (75% smaller) via `delta-debugging` in 8 steps.
...
harness/build/toml_harness triage/reports/939402a0547c/minimized.toml
