...
accepted: True
generated: 2026-08-17T03:14:56.308821+00:00
"""
...
def value(draw):
    return draw(st.one_of(
        ...
        st.text(alphabet="0123456789", min_size=1, max_size=20).map(lambda x: f"\\u{x}"),
        st.text(alphabet="0123456789", min_size=1, max_size=8).map(lambda x: f"\\U{x}"),
        st.text(alphabet="0123456789", min_size=1, max_size=2).map(lambda x: f"\\x{x}"),
