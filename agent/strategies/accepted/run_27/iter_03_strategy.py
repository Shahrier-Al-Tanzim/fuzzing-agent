...
accepted: True
generated: 2026-08-20T17:37:41.633876+00:00
"""
...
def array_of_tables_block(draw, suffix=""):
    ...
    for i in range(num_pairs):
        # Generates nested inline tables & extreme values inside array-of-tables
        lines.append(
            draw(
                pair_line(key_suffix=f"_{suffix}_p{i}", val_strat=value_strategy)
            )
        )
    return "\n".join(lines)
