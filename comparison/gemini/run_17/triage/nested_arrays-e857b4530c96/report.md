...
**Type:** `stack-overflow`
**Occurrences:** 24 input(s) mapped to this signature
...
38076 bytes → 38076 bytes (0% smaller) via `delta-debugging` in 6 steps.
...
harness/build/toml_harness triage/reports/run_17/nested_arrays-e857b4530c96/minimized.toml
