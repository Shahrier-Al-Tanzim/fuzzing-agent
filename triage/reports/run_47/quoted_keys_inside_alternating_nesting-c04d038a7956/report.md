...
**Type:** `stack-overflow`
**Occurrences:** 61 input(s) mapped to this signature
...
160008 bytes → 130329 bytes (18% smaller) via `delta-debugging` in 7 steps.
...
harness/build/toml_harness triage/reports/run_47/quoted_keys_inside_alternating_nesting-c04d038a7956/minimized.toml
