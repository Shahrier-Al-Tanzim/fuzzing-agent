...
**Type:** `stack-overflow`
**Occurrences:** 253 input(s) mapped to this signature
...
120012 bytes → 60012 bytes (50% smaller) via `delta-debugging` in 7 steps.
...
harness/build/toml_harness triage/reports/run_26/nested_arrays-e857b4530c96/minimized.toml
