...
**Type:** `stack-overflow`
**Occurrences:** 127 input(s) mapped to this signature
...
160013 bytes → 137193 bytes (14% smaller) via `delta-debugging` in 7 steps.
...
harness/build/toml_harness triage/reports/run_26/alternating_array_inline_table_nesting-80953bb88ca2/minimized.toml
