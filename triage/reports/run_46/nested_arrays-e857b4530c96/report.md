...
**Type:** `stack-overflow`
**Occurrences:** 77 input(s) mapped to this signature
...
96008 bytes → 96008 bytes (0% smaller) via `delta-debugging` in 6 steps.
...
harness/build/toml_harness triage/reports/run_46/nested_arrays-e857b4530c96/minimized.toml
