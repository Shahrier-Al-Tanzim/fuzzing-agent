...
accepted: True
generated: 2026-09-01T22:20:17.270367+00:00
"""
...
def document(draw):
    ...
    # Top-level key-values without any table header
    num_top_kv = draw(st.integers(0, 5))
    top_keys = draw(
    ...
    # Section tables (standard or array of tables)
    num_sections = draw(st.integers(0, 5))
    section_keys = draw(
        st.lists(key, min_size=num_sections, max_size=num_sections, unique=True)
    )
