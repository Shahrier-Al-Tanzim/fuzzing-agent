...
**Type:** `stack-overflow`
**Occurrences:** 68 input(s) mapped to this signature
...
96008 bytes → 18489 bytes (81% smaller) via `delta-debugging` in 22 steps.
...
harness/build/toml_harness triage/reports/run_47/nested_arrays-939402a0547c/minimized.toml
